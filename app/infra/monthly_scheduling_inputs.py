...
def _build_worker_ordering() -> tuple[list[str], dict[str, str]]:
...
def build_monthly_scheduling_inputs(
    *,
    ...
    - monthly people ordering still follows workers.json
    - request leave overrides are applied at the monthly API boundary
    """

    ordered_names, role_by_name = _build_worker_ordering()
